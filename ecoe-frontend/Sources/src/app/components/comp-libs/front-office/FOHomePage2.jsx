      ...
      <PageCPS domainType={SD_FO}>      
        ...
        <SectionWrapper items={navbarItems}>
          ...
          <WrapperItem name="highlight">
            ...
            <SectionFull>
              <ContainerCps>
                <Wrapper>
                  <GridCardRPF
                    search={sectionHighlinghtSearch}
                    render={searchCritical =>
                      <GridCard
                        products={searchCritical}
                        typeGrid={typeGrid}
                        domainType={SD_FO}
          ...
          <WrapperItem>
            <ContainerCps>
              <Wrapper padding>
                ...
                <GridCardRPF
                  search={sectionOrderProductsSearch}
                  render={searchCritical =>
                    <GridCard
                      products={searchCritical}
                      typeGrid={typeGrid}
                ...
                <div style={{ textAlign: 'center', }}>
                  <Buttons type="1" label={`Xem tất cả (${25}+ sản phẩm)`} />
                </div>
              </Wrapper>
            </ContainerCps>
          </WrapperItem>
          ...
          <WrapperItem>
            ...
            <GridCardRPF
              search={sectionLatestViewSearch}
              render={searchCritical =>
                <LatestViewCarousel products={searchCritical} />
              }>
            </GridCardRPF>
