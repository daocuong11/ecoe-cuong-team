										...
										<FlexItem>
											...
											<FormInline>
												...
												<FormGroup>
													...
													<FormControl value={_.get(item, 'totalPieces', '')} onChange={this.updateField(['subAreas', index, 'totalPieces'])} block/>
												</FormGroup>
											</FormInline>
											<FormInline>
												<FormGroup>
