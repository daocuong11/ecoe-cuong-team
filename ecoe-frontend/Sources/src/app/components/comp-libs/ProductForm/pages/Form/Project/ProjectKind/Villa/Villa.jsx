										...
										<FlexItem>
											...
											<FormInline>
												...
												<FormGroup>
													...
													<FormControl value={_.get(item, 'totalVilla', '')} onChange={this.updateField(['subAreas', index, 'totalVilla'])} block/>
												</FormGroup>
											</FormInline>
											<FormInline>
												<FormGroup>
