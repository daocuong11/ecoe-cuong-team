									...
									<div>
										<FormInline>
											...
											<FormGroup>
												...
												<div>
													<FormControl value={_.get(item, ['price', 0], '')} onChange={this.updateField(['list', index, 'price', 0])} width={180}/>
													<Text small bold>đến</Text>
													<FormControl value={_.get(item, ['price', 1], '')} onChange={this.updateField(['list', index, 'price', 1])} width={180}/>
												</div>
											</FormGroup>
										</FormInline>
										<FormInline>
