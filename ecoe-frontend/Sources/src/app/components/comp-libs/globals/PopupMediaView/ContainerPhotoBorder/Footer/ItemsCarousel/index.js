...
const SliderItem = styled.div`
  ...
  border: ${props => props.backgroundColor && "1px dashed #00837b"};
  flex-shrink: 0;
...
const CarouselChevron = styled.div`
  position: absolute;
  height: 100%;
  // width: ${(props) => props.chevronWidth}px;
  cursor: pointer;
  top: 0;
  display: flex;
  align-items: center;
  ...
  renderContent({ measureRef, containerWidth, containerHeight }) {
    ...
    return (
      <CarouselWrapper {...props}>
        ...
        />
        {
          _showRightChevron && <CarouselRightChevron
        ...
        {
          _showLeftChevron && <CarouselLeftChevron
            chevronWidth={chevronWidth}
            outsideChevron={outsideChevron}
