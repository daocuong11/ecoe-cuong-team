...
export const withSearchCriticalRPF = (WrappedComponent)=>{
  return class SearchCriticalRP extends React.Component {
...
export default withApollo(withSearchCriticalRPF);
